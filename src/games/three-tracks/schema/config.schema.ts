...
/**
 * Ce qu'un auteur de parcours écrit pour ce jeu, et rien de plus : le nombre de
 * tours, le budget d'attention disponible à chaque tour, le plafond posable sur
 * un seul chantier, les seuils de dérive et de mort, et la liste des chantiers
 * ouverts au départ.
 *
