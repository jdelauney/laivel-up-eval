...
> **Repris le 30/08, après la décision produit.** La règle `false-positives-at-most` a existé et a été retirée. Le barème fait déjà payer chaque marque fausse un point ; un second critère qui les aurait recomptées contre un seuil séparé les aurait punies deux fois pour la même marque. Le garde-fou contre la saturation est désormais le barème lui-même : marquer toutes les lignes de l'extrait rend cinq bonnes réponses et dix-neuf mauvaises. La règle retirée ne survit nulle part — un type déclaratif que plus aucun parcours n'appelle serait du code mort.
