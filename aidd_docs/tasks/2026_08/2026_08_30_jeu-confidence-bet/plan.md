...
| Les deux seuils de mise, 30 et 70, sont **symétriques autour de la mise neutre** | La première écriture reprenait le « sous 50 % » de la story, et l'asymétrie s'est mesurée après coup : « moyenne sous 50 » était satisfait par 6 des 15 paires possibles, « moyenne au-dessus de 70 » par 2. Se méfier du mauvais code était trois fois plus facile que faire confiance au bon, ce qui sous-crédite la confiance justifiée dans un produit qui porte sur du code d'IA. Ajouter des extraits n'y changeait rien : l'asymétrie tient à ce que 50 et 70 ne sont pas images l'un de l'autre autour de la mise neutre, et seul un miroir la ferme. `c1` passe donc à 30, image de 70. La story a été reprise en conséquence — un contrat qui contredirait le code ne vaudrait rien |
| Les deux seuils demandent un **engagement**, pas un simple penchant | Le miroir pouvait aussi se faire à 50 et 50, mais « moyenne au-dessus de 50 sur les extraits sains » est satisfait en penchant à peine du bon côté. Un jeu qui mesure la confiance engagée ne peut pas se contenter d'un critère que l'on satisfait sans s'engager. À 30 et 70, chaque critère exige d'avoir tranché au moins une fois franchement, dans son sens |
